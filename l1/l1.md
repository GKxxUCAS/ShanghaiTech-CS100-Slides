...
> "signature": consisting of the return-type, parameters, and some other possible information ${}^{\textcolor{red}{1}}$
...
${}^{\textcolor{red}{1}}$ "Signature" is not a standard terminology in C. In C++, a function's signature does **not** contain its return type.
